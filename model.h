...
public:
	...
	enum ModelType
	{
		MODEL_PLAYER_BODY,
		MODEL_PLAYER_HEAD,
		MODEL_PLAYER_FOREARM_RIGHT,
		MODEL_PLAYER_ARM_RIGHT,
		MODEL_PLAYER_FOREARM_LEFT,
		MODEL_PLAYER_ARM_LEFT,
		MODEL_PLAYER_LEG_RIGHT,
		MODEL_PLAYER_FOOT_RIGHT,
		MODEL_PLAYER_LEG_LEFT,
		MODEL_PLAYER_FOOT_LEFT,
